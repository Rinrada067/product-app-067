...
function RegisterPage() {
    ...
    const [role, setRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("user") // ค่าเริ่มต้นเป็น user
    ;
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            console.error(err);
            setError("เกิดข้อผิดพลาดในเซิร์ฟเวอร์");
        } finally{
            setLoading(false);
        }
    }
...
_s(RegisterPage, "sHpT3X4ZfjYjpFkTbu3BDoXyhn4=");
_c = RegisterPage;
var _c;
