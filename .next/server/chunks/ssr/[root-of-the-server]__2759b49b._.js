...
function ProfilePage() {
    const [currentPassword, setCur] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    async function submit(e) {
        ...
        res.ok ? setMsg({
            ok: data.message || 'เปลี่ยนรหัสผ่านสำเร็จ'
        }) : setMsg({
            err: data.error || 'ไม่สำเร็จ'
        });
        setCur('');
        setNew('');
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2759b49b._.js.map