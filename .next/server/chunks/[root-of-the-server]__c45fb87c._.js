    ...
    try {
        ...
        if (!username?.trim() || !password?.trim()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Username/Password ห้ามว่าง'
            }, {
                status: 400
            });
        }
        // ตรวจว่ามี username นี้แล้วหรือยัง
        const exists = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
                username
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c45fb87c._.js.map