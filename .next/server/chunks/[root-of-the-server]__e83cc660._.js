...
async function POST(req) {
    ...
    if (!body.name || !body.description || typeof body.price !== 'number' || typeof body.categoryId !== 'number') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'ข้อมูลไม่ครบหรือผิดประเภท'
        }, {
            status: 400
        });
    }
    // แก้ไขตรงนี้ ใช้ id แทน c_id
    const categoryExists = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.findUnique({
        where: {
            c_id: body.categoryId
        }
    });
    if (!categoryExists) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e83cc660._.js.map