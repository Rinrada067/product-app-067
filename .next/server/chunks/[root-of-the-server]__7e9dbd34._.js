...
async function POST(req) {
    ...
    if (!body.name || typeof body.name !== 'string') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'กรุณาระบุชื่อหมวดหมู่ (name)'
        }, {
            status: 400
        });
    }
    try {
        const newCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.create({
            data: {
                name: body.name
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e9dbd34._.js.map